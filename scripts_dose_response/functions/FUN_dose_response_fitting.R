...
fit_dose_response_model_course <- function(params,env_data,control_data,names_params, .response_function.){
  ...
  if(length(which(growth_modelled==0)) == length(growth_modelled)){
    skill_score <- 10000
  }
